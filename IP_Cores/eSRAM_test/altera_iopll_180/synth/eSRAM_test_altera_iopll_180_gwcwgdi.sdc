...
#    * The helper routines are defined in eSRAM_test_altera_iopll_180_gwcwgdi_pin_map.tcl
#
# NOTE
# ----
...
source "$script_dir/eSRAM_test_altera_iopll_180_gwcwgdi_parameters.tcl"
source "$script_dir/eSRAM_test_altera_iopll_180_gwcwgdi_pin_map.tcl"
...
if {[info exists ::GLOBAL_top_eSRAM_test_altera_iopll_180_gwcwgdi_corename_ai_pll_db]} {
    # Clean-up stale content
    unset ::GLOBAL_top_eSRAM_test_altera_iopll_180_gwcwgdi_corename_ai_pll_db
}
catch {ai_initialize_pll_db ::GLOBAL_top_eSRAM_test_altera_iopll_180_gwcwgdi_corename_ai_pll_db} err_intializing_db

# If multiple instances of this core are present in the
# design they will all be constrained through the
# following loop
set instances [ array names ::GLOBAL_top_eSRAM_test_altera_iopll_180_gwcwgdi_corename_ai_pll_db ]
foreach { inst } $instances {
    ...
    lassign $::GLOBAL_top_eSRAM_test_altera_iopll_180_gwcwgdi_corename_ai_pll_db($inst) base_clock_data_dict gen_clock_data_dict
