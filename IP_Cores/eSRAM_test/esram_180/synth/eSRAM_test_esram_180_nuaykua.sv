...
module eSRAM_test_esram_180_nuaykua
    #(
        //==========================//
    ...
    (* altera_attribute = "-name FORCE_HYPER_REGISTER_FOR_PERIPHERY_CORE_TRANSFER ON"*)  logic  iopll_lock2core_reg/* synthesis dont_merge */;
    ...
    fourteennm_cpa fourteennm_cpa_component (
        ...
        defparam    fourteennm_cpa_component.pa_exponent_0  = 3'b001;
        defparam    fourteennm_cpa_component.pa_exponent_1  = 3'b001;
