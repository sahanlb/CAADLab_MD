...
# ACDS 18.0 219 linux 2018.10.10.17:56:22
...
# ----------------------------------------
# If FIFO_Test is one of several IP cores in your
...
TOP_LEVEL_NAME="FIFO_Test.FIFO_Test"
QSYS_SIMDIR="./../"
...
set LD_LIBRARY_PATH [dict merge $LD_LIBRARY_PATH [dict get [FIFO_Test::get_env_variables $SIMULATOR_TOOL_BITNESS] "LD_LIBRARY_PATH"]]
...
set ELAB_OPTIONS ""
append ELAB_OPTIONS [FIFO_Test::get_elab_options $SIMULATOR_TOOL_BITNESS]
puts "ELAB_OPTIONS+=\"$ELAB_OPTIONS\""
set SIM_OPTIONS ""
append SIM_OPTIONS [FIFO_Test::get_sim_options $SIMULATOR_TOOL_BITNESS]
...
source $QSYS_SIMDIR/common/xcelium_files.tcl
set libraries [dict merge $libraries [FIFO_Test::get_design_libraries]]
...
source $QSYS_SIMDIR/common/xcelium_files.tcl
set memory_files [concat $memory_files [FIFO_Test::get_memory_files "$QSYS_SIMDIR"]]
...
source $QSYS_SIMDIR/common/xcelium_files.tcl
set design_files [dict merge $design_files [FIFO_Test::get_common_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR"]]
...
set files [list]
source $QSYS_SIMDIR/common/xcelium_files.tcl
set files [concat $files [FIFO_Test::get_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR"]]
