...
static const bool ENABLE_PRINT_DETAIL_MESSAGE = 1;            	         	// Print out detailed message showing which step the program is working on
static const bool ENABLE_OUTPUT_ENERGY_FILE = 1;              	         	// Print out the energy result to an output file
static const int SIMULATION_TIMESTEP = 300000;                            	// Total timesteps to simulate
